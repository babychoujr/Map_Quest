...
#input.py
#   In this module, input for the reuqest is acquired from user.
# The input information is processed for later stages.
# This input.py also has the main() function
...
def main():
    ...
    try:
        ...
        sys.exit(1)
    info_entry = result['info']
    status_code = info_entry['statuscode']
    if status_code == 402:
        print()
